            ...
            <div class="row gx-4">
                {{-- <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        @if($event->avatar)
                        <img src="{{ asset('storage/'.$event->avatar) }}" class="avatar avatar-sm me-3"
                            alt="{{ $event->name }}">
                        @else
        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-4">
                <div class="card h-100">
                    ...
                    <div class="card-body p-3">
                        <ul class="list-group">
                            @foreach ($event->friends as $event)
                            <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                ...
                                <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">Confirmed</a>
                            </li>
                            @endforeach
